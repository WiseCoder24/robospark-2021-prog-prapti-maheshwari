import cv2
img=cv2.imread(r"C:\Users\vithi\Desktop\ML TRF\IP IMAGES\thresholding.jpeg",cv2.IMREAD_GRAYSCALE)
...
cv2.imwrite(r"C:\Users\vithi\Desktop\ML TRF\IP IMAGES\simple_thresh.JPG",simple_thresh)
cv2.imshow("simple_thresh_inv",simple_thresh1)
cv2.imwrite(r"C:\Users\vithi\Desktop\ML TRF\IP IMAGES\adaptive_thresh1.JPG",simple_thresh1)
...
cv2.imwrite(r"C:\Users\vithi\Desktop\ML TRF\IP IMAGES\adaptive_thresh.JPG",adaptive_thresh)
cv2.imshow("adapt_mean_inv",adaptive_thresh0)
cv2.imwrite(r"C:\Users\vithi\Desktop\ML TRF\IP IMAGES\adaptive_thresh0.JPG",adaptive_thresh0)
cv2.waitKey(0)
...
cv2.imwrite(r"C:\Users\vithi\Desktop\ML TRF\IP IMAGES\adaptive_thresh1.JPG",adaptive_thresh1)
cv2.imshow("adapt_guass_inv",adaptive_thresh2)
cv2.imwrite(r"C:\Users\vithi\Desktop\ML TRF\IP IMAGES\adaptive_thresh2.JPG",adaptive_thresh2)
